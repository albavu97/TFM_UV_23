...
if(params$imported$file4 == "FALSE"){
  show_text4 <- FALSE
}else{
  show_text4 <- TRUE
}
...
cat("## Comentarios introducidos cuarta tabla:")
cat("\n")
...
``` {r boxplot_long4, echo=FALSE,eval=show_plot4, message=FALSE, warning=FALSE, paged.print=FALSE,results='asis',fig.align = 'center'}        
var1 <- params$imported$lista[1]
var2 <- params$imported$lista[2]
var3 <- params$imported$lista[3]
